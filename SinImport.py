...
print(t)
if(t != 0):
    varUsuario = pickle.load(regEstudiantes)
    print(varUsuario.email)   
    print(varUsuario.biografia)   
    print(varUsuario.sexo)   
    print(varUsuario.ciudad)   
    print(varUsuario.hobbies)   
    print(varUsuario.estado)   
    varUsuario2 = pickle.load(regEstudiantes)
    print(varUsuario2.email)   
    print(varUsuario2.biografia)   
    print(varUsuario2.sexo)   
    print(varUsuario2.ciudad)   
    print(varUsuario2.hobbies)   
    print(varUsuario2.estado)   